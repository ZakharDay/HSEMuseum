...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { background: @gallery.background, teaser: @gallery.teaser, title: @gallery.title } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { background: @gallery.background, teaser: @gallery.teaser, title: @gallery.title } }
